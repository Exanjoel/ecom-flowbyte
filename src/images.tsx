      ...
      <div className="flex p-5  justify-evenly items-center ">
        <div className=" m-9 hidden lg:block relative">
          ...
          <div className="absolute w-full top-12  flex flex-col ">
            ...
            <a href="./product/:id" className="bg-amber-400 p-3 px-5 m-auto w-1/2  text-sm rounded-lg text-slate-950 font-bold text-center uppercase"> 
              Shop now 
            </a>
          </div>
        </div>
        ...
        <div className="m-9 hidden lg:block relative">
          ...
          <div className="absolute w-full top-12 flex flex-col">
            ...
            <button className="bg-amber-400 p-3 px-5 m-auto w-1/2  text-sm rounded-lg text-slate-950 font-bold uppercase">
              Shop now
            </button>
          </div>
        </div>
